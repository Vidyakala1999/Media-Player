...
export const deleteHistory = async(id)=>{
    //make delete http request "http://localhost:4000/history/id" to delete videos from json-serveer return response to the videocard component
...
export const updateCategory = async(id,body)=>{
    //make PUT http request "http://localhost:4000/categories" to delete videos from json-serveer return response to the category component
